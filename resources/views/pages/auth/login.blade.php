            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control border-end-0 rounded-0 rounded-start" name="password" id="password">
                    ...
                    <div class="text-center">
                        Don't have an account? <a href="{{ route('sign-up') }}" class="text-decoration-underline">Sign up</a>
                    </div>
